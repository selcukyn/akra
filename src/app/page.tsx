...
const CountdownPage = () => {
  ...
  return (
    <div
      className="min-h-screen flex flex-col items-center justify-center bg-zinc-800 text-white p-4 selection:bg-primary selection:text-primary-foreground"
    >
      <div className="relative z-10 flex flex-col items-center text-center bg-zinc-700 p-6 sm:p-8 md:p-12 rounded-xl shadow-2xl max-w-3xl w-full">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 md:gap-6 mb-8 sm:mb-10 w-full">
          <div className="bg-zinc-600 p-3 sm:p-4 md:p-6 rounded-lg shadow-lg">
